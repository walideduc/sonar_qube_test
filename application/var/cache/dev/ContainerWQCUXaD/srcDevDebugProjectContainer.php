...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            ...
            'App\\Controller\\Rqms\\Statistics\\ItalyOutlets\\IndexController' => __DIR__.'/getIndexControllerService.php',
            'App\\Controller\\Rqms\\Statistics\\Outlets\\IndexController' => __DIR__.'/getIndexController2Service.php',
            'App\\Controller\\Rqms\\Statistics\\Search\\IndexController' => __DIR__.'/getIndexController3Service.php',
            'App\\Controller\\Rqms\\Statistics\\TPOnline\\IndexController' => __DIR__.'/getIndexController4Service.php',
            'App\\Controller\\Rqms\\Statistics\\Transaction\\IndexController' => __DIR__.'/getIndexController5Service.php',
            ...
            'console.command.public_alias.App\\Command\\CreateTransactionCommand' => __DIR__.'/getCreateTransactionCommandService.php',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('transaction.created', array(0 => function () {
            return ($this->privates['App\Domain\Transaction\Subscriber\CreateConsolidatedTransaction\CreateConsolidatedTransactionSubscriber'] ?? $this->load(__DIR__.'/getCreateConsolidatedTransactionSubscriberService.php'));
        }, 1 => 'onCreateAction'), 100);
        $instance->addListener('consolidated-transaction.created', array(0 => function () {
            return ($this->privates['App\Domain\Transaction\Subscriber\NotificationConsolidatedTransaction\NotificationConsolidatedTransactionSubscriber'] ?? $this->load(__DIR__.'/getNotificationConsolidatedTransactionSubscriberService.php'));
        }, 1 => 'onConsolidatedTransactionCreated'), 0);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'aws.config': $value = array(
                'region' => $this->getEnv('AWS_SQS_REGION'),
                'version' => 'latest',
                'credentials' => array(
                    'key' => $this->getEnv('AWS_ACCESS_KEY_ID'),
                    'secret' => $this->getEnv('AWS_SECRET_ACCESS_KEY'),
                ),
            ); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'console.command.ids' => array(
                0 => 'console.command.public_alias.App\\Command\\CreateTransactionCommand',
            ),
        );
    }
}
